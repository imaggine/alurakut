  ...
  return (
    <AlurakutMenu.Wrapper isMenuOpen={isMenuOpen}>
      <div className="container">
        <AlurakutMenu.Logo src={`https://unissulsupermercados-my.sharepoint.com/personal/marcos_unissul_com/Documents/Arquivos%20teste/logo.png`} />
        ...
        <nav>
          ...
          <div>
            <input placeholder="Pesquisar no Gkut" />
          </div>
        </nav>
